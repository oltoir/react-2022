...
function NewsDetailPage(){
  ...
  return(
    <GlobalContext.Provider
      value={{ news }}
    >
      <Flex width={1000} alignItems='center' justifyContent='center' flexDirection='column' gap='2' margin='0 auto' marginBottom={20} marginTop={20} height='100%' bgColor='gray.100'>
